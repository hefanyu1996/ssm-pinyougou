...
public class GoodsController {
	...
	public Result update(@RequestBody Goods goods){
		try {
			...
			String currSelleId = SecurityContextHolder.getContext().getAuthentication().getName();
			if(!goods.getTbGoods().getSellerId().equals(currSelleId) || !goods1.getTbGoods().getSellerId().equals(currSelleId)){
